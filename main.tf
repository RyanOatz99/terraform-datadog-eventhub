...
resource "datadog_monitor" "eventhub_namespace_failed_requests" {
  ...
  tags = concat(
    [
      ...
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_eventhub_namespace_failed_requests}",
...
resource "datadog_monitor" "eventhub_namespace_no_outgoing_messages" {
  ...
  tags = concat(
    [
      ...
      "customer_id:${var.customer_id}",
      "team_in_charge:${var.team_in_charge}",
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_eventhub_namespace_no_outgoing_messages}",
...
resource "datadog_monitor" "eventhub_namespace_status" {
  ...
  tags = concat(
    [
      ...
      "customer_id:${var.customer_id}",
      "team_in_charge:${var.team_in_charge}",
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_eventhub_namespace_status}",
...
resource "datadog_monitor" "eventhub_namespace_throttling_requests" {
  ...
  tags = concat(
    [
      ...
      "customer_id:${var.customer_id}",
      "team_in_charge:${var.team_in_charge}",
      "type:${var.monitor_type != "" ? var.monitor_type : var.type_eventhub_namespace_throttling_requests}",
